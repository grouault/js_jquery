...
<head>
	...
	<title>Ma librairie jQuery</title>
...
<body>
  ...
  <div id="wrapper">
  	<div id="branding">
			<h1>Librairie jQuery</h1>
  	</div>
  	<div id="container">
  		<div id="content">
  			<h2>Résultats de la recherche</h2>
  			<p>Résultats de la recherche de&nbsp;: <?php print $_GET['search-text']; ?></p>
      ...
      <div id="primary-nav">
    		<ul>
    			<li><a href="../books/index.html">Lives</a></li>
  	...
  	<div id="secondary-nav">
  			<h3><a href="../cart/index.html">Votre panier</a></h3>
  			<ul>
  				<li>Lorem ipsum dolor</li>
  				<li>Lorem ipsum dolor</li>
  				<li>Lorem ipsum dolor</li>
